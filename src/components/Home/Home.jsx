    ...
    return (
        <div className=" relative px-5 w-full flex flex-col justify-center items-center flex-grow font-outfit md:mx-72 pt-3 md:px-5 bg-mainBackground">
            ...
            <Dropdown className="md:hidden">
                ...
                <DropdownMenu className="bg-[#282727] rounded-xl py-2 font-outfit"
                ...
                >
                    
                    {
                        VoiceList.map((msg, index) => (
                            <DropdownItem className={` transition ease-in-out font-outfit  hover:text-white  p-1 px-3 rounded-full ${
                            activityIndex === index
                                ? " text-white shadow"
                                : " text-[white]"
            ...
            <div className="flex flex-col overflow-x-clip  h-[440px] w-full flex-grow overflow-y-auto px-2  ">
                <div className=" md:w-full flex flex-col items-end space-y-2  px-2">
                    {chatHistory.map((msg, index) => (
                        ...
                        {msg.type === "user" ? <h1 className=" text-right pr-4 font-bold text-blue-700">YOU</h1> : <h1 className=" self-start pl-4 font-bold text-blue-700">YAI</h1>}
                        </>
                    ))}
