                ...
                <Dropdown className="md:hidden">
                    <DropdownTrigger className="py-2">
                        <Button
                            variant="solid"
                            color="primary"
                            className="capitalize font-outfit ring-2 ring-blue-500 focus:ring-blue-400 rounded-full mb-3 transition ease-in-out"
                        >
                            {selectedValue}
                        </Button>
                    </DropdownTrigger>
                    <DropdownMenu
                        className="bg-[#282727] rounded-xl py-2 font-outfit"
                    ...
                    >
                        {VoiceList.map((msg, index) => (
                            <DropdownItem
                                className={` transition ease-in-out font-outfit  hover:text-white  p-1 px-3 rounded-full ${
                                    activityIndex === index
                                        ? " text-white shadow"
                                        : " text-[white]"
                                }`}
                ...
                <div className=" md:w-full  flex flex-col items-end space-y-2  px-2">
                    {chatHistory.map((msg, index) => (
                        <>
                            ...
                            {msg.type === "user" ? (
                                <h1 className=" text-right pr-4 font-bold text-blue-700">
                                    YOU
                                </h1>
                            ) : (
                                <h1 className=" self-start pl-4 font-bold text-blue-700">
                                    YAI
                                </h1>
                            )}
                        </>
